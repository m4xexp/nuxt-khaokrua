  ...
  <div>
    ...
    >
      ...
      <ul class="nav-menu">
        ...
        <li class="btn-profile" v-for="data in user" :key="data.fname">
            ...
            <v-card>
              <v-list-item-content>
                <div class="mx-auto text-center">
                  ...
                  <v-btn x-large icon>
                    <v-avatar>
                      <img :src="data.profilePic" alt="nong" />
                    </v-avatar>
                  </v-btn>
                  <div  class="prfile-title" style="margin: 10px" >
                    <h4 class="profile-title-name">{{ data.fname }}</h4>
...
export default {
  ...
  methods: {
    getDataUser() {
      ...
      .then(res=>{
        this.user = res.data
        console.log('data here', this.user)
      })
    },
    login() {
      this.dialog = true
